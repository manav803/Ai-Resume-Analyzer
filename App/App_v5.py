...
# Background added
# different in sidebar and main content?
...
# sql connector
connection = pymysql.connect(host='localhost',user='root',password='Manav@9999',db='cv')
...
def run():
            ...
            if (len(act_name) != 0) and (len(act_mail) != 0) and (len(act_mob) != 0):
                ...
                # if st.button('Submit'):
                    ...
                    if resume_data:
                        ...
                        st.markdown('## Your Resume Writing Score:')
    ...
    ###### CODE FOR ABOUT PAGE ######
        ...
        <p align="justify">
            <b><h2>How to use the Ai Resume Analyzer Tool:  </h2></b> 
            <b><h2>User </h2></b> <br/>
    ...
    ###### CODE FOR ADMIN SIDE (ADMIN) ######
        ...
        if st.button('Login'):
            ...
            ## Credentials 
            if ad_user == 'admin' and ad_password == 'adminpsd':
